...
% % g Method for the Smoothed Primal Problem
% opts6 = []; % modify options
% tic;
% [x6, iter6, out6] = gl_GD_primal(x0, A, b, mu, opts6);
% t6 = toc;

% % Fast (Nesterov/Accelerated) g Method for the Smoothed Primal Problem.
% opts7 = []; % modify options
% tic;
% [x7, iter7, out7] = gl_FGD_primal(x0, A, b, mu, opts7);
% t7 = toc;

% Proximal g Method for the Primal Problem
opts8 = []; % modify options
tic;
[x8, iter8, out8] = gl_ProxGD_primal(x0, A, b, mu, opts8);
t8 = toc;

% Fast Proximal g Method for the Primal Problem
